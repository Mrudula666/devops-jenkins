node{
    ...
    stage('deploy to tomcat'){
       deploy adapters: [tomcat8(credentialsId: '7de1de9d-8e53-441a-8a2d-c06b708e9dcd', path: '', url: 'http://localhost:9090/webapp/')], contextPath: 'webapp', onFailure: false, war: '**/*.war'
    }
